...
- Depends on: `PLAN-0015` local migration `0011`
- Owner: Product owner
...
- Migration `0011`은 `betting_enrollment`, `credit_account`와 불변 원장 schema를
...
bot runtime에 연결하지 않는다. `0011`의 Production 적용은 별도 exact owner gate와
