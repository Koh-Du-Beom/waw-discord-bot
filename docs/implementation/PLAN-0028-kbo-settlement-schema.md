...
- Depends on: `PLAN-0025`, `PLAN-0026`
- Owner: Product owner
...
- 변경 예상 파일: `migrations/0015_kbo_settlement_schema.sql`, migration runner,
...
- additive `0015`에 revision별 불변 settlement, 같은 bet의 correction chain과
