...
- Depends on: `PLAN-0023` schema contract
- Owner: Product owner
...
- `PLAN-0023`은 bet 입력 형태와 중복·원장 참조 schema를 local/disposable에서
...
- `ADR-0031`은 allowlist된 외부 봇 공개 응답만 trust boundary에서 정규화하고
