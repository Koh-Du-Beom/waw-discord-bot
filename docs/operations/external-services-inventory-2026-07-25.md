...
| 외부 KBO Discord 봇 | `ADR-0031`에 따라 정확한 application·guild·channel·공개 응답 schema allowlist를 쓰는 조건부 source로 선택. 정상 경기·정정 schema, 개발자 허가, Discord 정책 및 국내 공개 제공 승인이 남아 production 수집·베팅은 default-off |
