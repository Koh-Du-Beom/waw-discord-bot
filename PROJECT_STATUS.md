...
로컬 foundation Task 1~5, PLAN-0002 Task 1~3과 `ADR-0010`~`ADR-0011`을 완료했습니다. 다음은 disposable Ubuntu 24.04에서 systemd process/secret, crash/reboot/rollback과 1GB resource Spike를 실행하는 작업입니다.
