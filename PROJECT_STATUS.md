...
D-03·D-05·D-08 조사와 소유자 결정 완료, D-07 인증·인가·세션 조사 준비
...
- D-07 인증 연구 전까지 D-05 저장소와 D-08 배포·통신 경계 선택 보류

## 다음 작업

`OWN-013`, `OWN-016`~`OWN-025`와 D-03·D-05·D-08의 경계를 입력으로
D-07 인증·인가·세션 후보를 조사합니다. D-07 연구 뒤에야 저장소와
D-08 배포·통신 경계를 함께 선택할 수 있으며, 아직 ADR, Spike나 구현 계획을 작성하지 않습니다.
