...
D-05 저장소 후보 검증 준비 중 (Supabase Free disposable project 생성 완료, 합성 SQL 미실행)
...
- Supabase Free 검증용 별도 disposable project `waw-storage-spike-20260721` 생성 완료; 기존 production project는 사용하지 않음. DB password는 채팅·문서에 기록하지 않음
