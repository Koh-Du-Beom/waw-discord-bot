...
- D-08 조사 결과의 차단 문제와 사용자 결정 항목 검토 준비
- 예상 사용량과 고정비가 미확정인 항목의 복수 시나리오 유지

## 다음 작업

`docs/research/technology-options/deployment-boundary-and-internal-communication.md`를 검토해
네 배포 형태와 네 통신 방식의 근거 누락, 차단 문제와 사용자 결정 항목만 정리합니다.
인증 기술은 D-07에 남기고 아직 ADR이나 Spike를 작성하지 않습니다.
